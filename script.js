window.onload = function () {
    ...
    //CRIANDO VARIÁVEL COM TODAS AS INFORMAÇÕES DAS MUSICAS

    var data = [
        {
            music: "Disease",
            artist: "Matchbox Twenty",
            imageFile: "./assets/trackImages/disease.PNG",
            audioFile: "./assets/trackMedias/Matchbox Twenty - Disease.mp3",
        },
        {
            music: "Harder To Breathe",
            artist: "Maroon 5",
            imageFile: "./assets/trackImages/harderToBreathe.PNG",
            audioFile: "./assets/trackMedias/Maroon 5 - Harder To Breathe.mp3",
        },
        {
            music: "Supermassive Black Hole",
            artist: "Muse",
            imageFile: "./assets/trackImages/supermassiveBlackHole.PNG",
            audioFile: "./assets/trackMedias/Muse - Supermassive Black Hole.mp3",
        },
        {
            music: "Teenagers",
            artist: "My Chemical Romance",
            imageFile: "./assets/trackImages/teenagers.PNG",
            audioFile: "./assets/trackMedias/My Chemical Romance - Teenagers.mp3",
        },
        {
            music: "Thnks Fr Th Mmrs",
            artist: "Fall Out Boy",
            imageFile: "./assets/trackImages/thnksFrThMmrs.PNG",
            audioFile: "./assets/trackMedias/Thnks Fr Th Mmrs - Fall Out Boy.mp3",
        },
        {
            music: "Holiday",
            artist: "Green Day",
            imageFile: "./assets/trackImages/holiday.PNG",
            audioFile: "./assets/trackMedias/Green Day - Holiday.mp3",
        }
    ]
    ...
    function loadMusic() {
        ...
        musicTrack.src = data[index].audioFile;
        ...
        musicTrack.addEventListener("loadeddata", function () {
            ...
            musicName.innerText = data[index].music;
            artistName.innerText = data[index].artist;
            musicAlbum.src = data[index].imageFile;
        })
    }
    ...
    for (let i of data) {
        library.innerHTML += "<div class='libraryContent'><h4>" + i.music + "</h4>" + "<h4 style='font-weight: 400; font-style: italic;'>" + i.artist + "</h4></div>";
    }
